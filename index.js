...
let nameSongs = [
	...
	"HELLS BELLS", /*5*/
	"ROCK 'N' ROLL TRAIN", /*6*/
	"YOU SHOOK ME ALL NIGHT LONG", /*7*/
	"T.N.T.", /*8*/
	"WHOLE LOTTA ROSIE", /*9*/
	"DIRTY DEEDS DONE DIRT CHEAP", /*10*/
	"LET THERE BE ROCK", /*11*/
	"FOR THOSE ABOUT TO ROCK ", /*12*/
	"JAILBREAK", /*13*/
	"HIGH VOLTAGE", /*14*/
	"IT'S A LONG WAY TO THE TOP", /*15*/
	"ROCK AND ROLL AIN'T NOISE POLLUTION", /*16*/
	"SIN CITY", /*17*/
	"RIDE ON", /*18*/
	"IF YOU WANT BLOOD ", /*19*/
	"WHO MADE WHO", /*20*/
]
...
const headerColors = {
  ...
  2: ['#ff1b6b', '#ff00ff', '#32cd32'],
  3: ['#e81cff', '#f5ccd9', '#7fffd4'],
  4: ['#05c9fa', '#adff2f', '#dda0dd'],
  5: ['#f0e68c', '#800080', '#00bfff'],
  6: ['#50c878', '#ff1493', '#ff5858'],
  7: ['#e4f61e', '#87ceeb', '#00ff7f'],
  8: ['#ffeda0', '#4169e1', '#98ff98'],
  9: ['#ff00ff', '#fff44f', '#50c878'],
  10: ['#00ff87', '#0061ff', '#60efff'],
  11: ['#84ffc9', '#4169e1', '#eca0ff'],
  12: ['#e9d022', '#fffbaf', '#f86594'],
  13: ['#f4762d', '#ede342', '#5b6cf9'],
  14: ['#3d05dd', '#e0a9bb', '#f40752'],
  15: ['#b429f9', '#e0a9bb', '#26c5f3']
};
